...
# significantly altered later
# by Daniel Dotsenko dotsa@hotmail.com
...
if __name__ == '__main__':
	...
	menu_options = (
		...
		# ('Quit', None, 'QUIT') # Quit is auto-inserted by above code.
	)
