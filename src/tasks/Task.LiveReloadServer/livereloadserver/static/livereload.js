...
;(function(){
// Generated by CoffeeScript 1.3.3
var CCCP1, PROTOCOL_6, PROTOCOL_7, Parser, Protocol, ProtocolError,
...
Protocol.CLIENT_CONFIG_PROTOCOL_1 = CCCP1 = 'http://dvdotsenko.github.com/python-livereload/protocols/client-side-config-1/';

Protocol.PROTOCOLS = [PROTOCOL_6, PROTOCOL_7, CCCP1];
...
Protocol.Parser = Parser = (function() {
...
;(function(){
// Generated by CoffeeScript 1.3.3
var AlertHandler, AlertHandlerInitializer, Protocol, defaulthandler,
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
AlertHandler.DisplayAsAlert = defaulthandler = function(message) {
  return alert(message.message);
};

AlertHandler.ConsoleLogger = function(message) {
  return console.log('LiveReload - Message from server: ', message.message);
};

AlertHandler.MetaDataProcessor = function(message) {
  var action, _ref, _ref1;
  if (message.protocols && (_ref = Protocol.CLIENT_CONFIG_PROTOCOL_1, __indexOf.call(message.protocols, _ref) >= 0)) {
    action = new Function((_ref1 = message.metadata) != null ? _ref1.action : void 0);
    return setTimeout(action(0));
  }
};

AlertHandler.AlertHandlerInitializer = AlertHandlerInitializer = (function() {

  function AlertHandlerInitializer(hanlder1, handler2, etc) {
    var handlers;
    handlers = Array.prototype.slice.call(arguments) || [defaulthandler];
    return function(message) {
      var handler, parent, _i, _len, _results;
      parent = this;
      _results = [];
      for (_i = 0, _len = handlers.length; _i < _len; _i++) {
        handler = handlers[_i];
        _results.push((function(handler, parent, message) {
          return setTimeout(function() {
            return handler.call(parent, message);
          }, 10);
  ...
  return AlertHandlerInitializer;
...
;(function(){
// Generated by CoffeeScript 1.3.3
var Connector, PROTOCOLS, Parser, Version, _ref;

_ref = require('protocol').Protocol, Parser = _ref.Parser, PROTOCOLS = _ref.PROTOCOLS;
...
exports.Connector = Connector = (function() {
  ...
  Connector.prototype.connect = function() {
    //console.log("LiveReload. Connector.Connect.")
    var _this = this;
...
exports.Less = LessPlugin = (function() {
...
;(function(){
// Generated by CoffeeScript 1.3.3
var AlertHandler, Connector, LiveReload, Options, Reloader, Timer;
...
AlertHandler = require('alerthandler').AlertHandler;
...
exports.LiveReload = LiveReload = (function() {
  ...
  LiveReload.prototype.performAlert = new AlertHandler.AlertHandlerInitializer(AlertHandler.ConsoleLogger, AlertHandler.MetaDataProcessor);
